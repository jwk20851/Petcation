...
public class ManageReviewController {
	...
	@RequestMapping("/manageReview.bo")
	public ModelAndView manageReviewList(HttpServletRequest request) {
		List<BoardVO> manageReview = manageReviewListService.getmanageReviewList();
		...
		int totalCount = manageReview.size();
		int number = 0;
		...
		mav.setViewName("manageReview");
		mav.addObject("manageReview", manageReview);
