...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="afaq_insert_action.bo" method = "POST">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">FAQ(등록)</h1>
					</div>
    ...
    <tr height = "35">
				...
				<table border="1" width="100%" height= "100%" cellpadding="0" cellspacing="0" align="center" id = "board">
				<tr>
