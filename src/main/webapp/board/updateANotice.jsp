...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="anotice_update_action.bo" method = "POST">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">공지사항 수정</h1>
					</div>
    ...
    <tr height = "35">
					...
					<td width="100" align="center"><input type = "text" id = "title" name = "title" value = "${boardVO.title }"></td>
				...
				<tr>
					...
					<td width="630"><textarea style = "resize : none; height : 100%;" name="content" >${boardVO.content}</textarea>
					</td>
				</tr>
				...
				<tr>
    				...
    				파일첨부<input type="file" name="FileName" size = "20" maxlength = "30">${boardVO.noticefile }
					</td>
