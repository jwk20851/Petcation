...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="reservation.jsp"
					...
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">1대1문의조회</h1>
					</div>
					...
					<div class="out_container">
						...
						<c:if test="${empty boardVO.answer}">
							<table border="1" width="100%" cellpadding="0" cellspacing="0" align="center" id = "board"> 

								<tr height = "35">
								<input type="hidden" name="num" value="${boardVO.num}"> 
									<td width="200" align="center">${boardVO.title}</td>
									<td width="100" align="center">작성자</td>
									<td width="100" align="center"><fmt:formatDate pattern="yyyy-MM-dd " value="${boardVO.reg_date}"/></td>
								</tr>
							...
							<c:if test="${not empty boardVO.answer}">
							<table border="1" width="100%" cellpadding="0" cellspacing="0" align="center" id = "board"> 
								...
								<tr>
									<td colspan="3" height="200">${boardVO.answer}</td>
								</tr>
							</table>
							</c:if>
							<div class="clearfix" style="margin-top: 10px; width: 90%;">

								<button type="submit" align="right" class="back" onclick="document.location.href='viewMTMList.bo?'">이전</button>
								<button type="submit" class="delete" onclick="deleteCode(${boardVO.num})">삭제</button>
							</div>
							<br>
						</div>
		...
		function deleteCode(getNum){
			/* alert(getNum); */
	         if (confirm("정말 삭제하시겠습니까??") == true){    //확인
	             location.href="http://localhost:8088/petcation/MTMDelete.bo?num=" + getNum ;
