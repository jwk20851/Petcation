...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="mtm_insert_action.bo" method = "POST">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">1대1문의하기</h1>
					</div>
    ...
    <tr height = "35">
				...
				<tr>
					...
					OnClick="window.location='viewMTMList.bo'">
					</td>
    </tr>
