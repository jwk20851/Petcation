...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="afaq_update_action.bo"	method = "POST">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">FAQ수정</h1>
					</div>
    ...
    <tr height = "35">
    	<input type="hidden" name="num" value="${faqVO.num}"> 
					<td width="100" align="center"><input height="35" width="100%" type = "text" id = "title" name = "title" value = "${faqVO.title }"></td>
				...
				<tr>
					...
					<td width="630" height = "400"><textarea style = "resize : none;"  name="content" >${faqVO.content}</textarea>
					</td>
				</tr>
				...
				<tr>
    				...
    				파일첨부<input type="file" name="FileName" >${faqVO.noticefile}
</form>
					</td>
					<td colspan=2 align="right">
					<input type="submit" value="저장"  style = "width:20%; height:40px; float:right;margin-top:5%;" >
					<input type="button" value="이전" style = "width:20%; height:40px; float:right; margin-right:10px;margin-top:5%;"
					OnClick="window.location='afaqList.bo'">
					</td>
				</tr>
			</table>
							<br>
