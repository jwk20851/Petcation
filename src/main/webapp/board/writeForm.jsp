...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="boardWritePro.bo">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">리뷰작성</h1>
					</div>
		...
		<%-- 	<input type="hidden" name="num" value="${boardVO.num}">  --%>
			...
			<table width="100%" align="center">
				<tr>
					...
					<input type="button" value="이전" style = "width:30%; height:40px;  margin-right:5%;margin-top:5%;"
					OnClick="window.location='manageReview.bo'">
					<input type="submit" value="저장"  style = "width:30%; height:40px;  margin-right:5%;margin-top:5%;" >
					</td>
				</tr>
			</table>
