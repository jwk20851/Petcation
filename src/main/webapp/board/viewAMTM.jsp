					...
					<div class="out_container">
						...
						<c:if test="${not empty boardVO.answer}">
							...
							<div class="clearfix" style="margin-top: 10px; width: 90%;">
								<button type="button" class="answer" onclick="document.location.href='amtm_updateForm.bo?num=${boardVO.num}'">답변</button>
								<button type="submit" align="right" class="back" onclick="document.location.href='amtmList.bo'">이전</button>
							</div>
							<br>
						</div>
