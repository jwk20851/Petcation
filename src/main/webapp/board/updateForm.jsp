...
<body>
	...
	<div id = "body-content">
				...
				<form class="modal-content" action="boardUpdatePro.bo">
					<div class="head">
						<h1 style="font-size: 3vw; text-align: center;">마이페이지</h1>
					</div>
					...
					<div class="out_container">
						<div class="sidebar">
							<div class="sidenav">
								<h1
									style="font-size: 2vw; text-align: center; margin-top: 10px; margin-bottom: 10px">글수정</h1>
			...
			<table border="1" width="100%" height= "70%" cellpadding="0" cellspacing="0" align="center" id = "board"> 
				...
				<tr>
					...
					<td width="630">
					<textarea style = "resize : none; height : 100%;" name="content" ><%=article.getContent()%></textarea>
					</td>
				</tr>
