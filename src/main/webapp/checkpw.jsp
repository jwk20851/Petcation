...
<body>
	<div style="height: 100%; width: 100%;">
		<div id="id01" class="modal">
			<div id="body-content">
				...
				<form class="modal-content" action="checkpw.pet" name = "checkpwForm" id = "checkpwForm" onsubmit="return input_check()">
					<div class="head">
					<h1 style="font-size: 3vw; text-align: center">비밀번호 확인</h1>
					</div>
					...
					<div class="out_container">
						<div class="sidebar">
							<div class="sidenav">
								...
								<a href="#about">회원정보</a> <a href="#">반려동물관리</a> <a
							...
							<div class="containercheckpw">
								...
								<input type="password"
									style="width: 20%; height: 40px; margin-top: 10px; border-radius: 25px; color: black; font-size: 15px;"
									 id="password" placeholder=" 비밀번호" name="psw" required>
							</div>
							<div>
								<button type="submit" style="margin-top: 20px; width: 130px;">확인</button>
								<button type="button" style="width: 130px; margin-left: 10px;" onclick="location.href=main.jsp">취소</button>
							</div>
							<br>
						</div>
					</div>
	...
	<script>
		...
		function input_check(){
			...
			window.open("checkpwPopup.jsp", "비밀번호확인", "width=400, height=50, left=100, top=50");
			document.checkpwForm.target = "비밀번호확인";
		 	document.checkpwForm.action="checkpw.pet";
